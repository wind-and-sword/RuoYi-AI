package com.jf.common.utils.file;
...
import com.jf.common.exception.file.FileNameLengthLimitExceededException;
import com.jf.common.exception.file.FileSizeLimitExceededException;
import com.jf.common.exception.file.InvalidExtensionException;
import com.jf.common.utils.DateUtils;
import com.jf.common.utils.StringUtils;
import com.jf.common.utils.uuid.IdUtils;
import com.jf.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = JFConfig.getProfile();
    ...
    {
        int dirLastIndex = JFConfig.getProfile().length() + 1;
